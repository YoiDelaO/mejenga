...
from app.services.match_review_service import build_match_review_summary
...
async def analyze_match(
    ...
    match_multicamera_events = build_match_multicamera_events(camera_results)
    ...
    match_action_summary = build_match_action_summary(
        match_mode_validation=match_mode_validation,
        match_review_summary=match_review_summary,
    )
    match_action_required = match_action_summary["match_action_required"]
